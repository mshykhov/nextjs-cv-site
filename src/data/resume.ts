export const personalInfo = {
  ...
  email: "myronshykhov@gmail.com",
  telegram: "@mshykhov",
  whatsapp: "+380995173706",
  github: "https://github.com/mshykhov",
  linkedin: "https://linkedin.com/in/mshykhov",
...
export const techStack: TechCategory[] = [
  ...
  {
    name: "Backend",
    items: ["Spring Boot", "Spring Framework", "Spring Security", "Axon Framework", "Kotlin Coroutines", "Project Reactor", "REST", "gRPC", "OpenAPI"],
  },
  {
    name: "Messaging",
    items: ["Apache Kafka"],
  ...
  {
    name: "Databases",
    items: ["PostgreSQL", "MongoDB", "Redis", "BigQuery", "Hibernate", "Liquibase"],
  },
  {
    name: "Cloud & DevOps",
    items: ["AWS", "GCP", "Docker", "Kubernetes", "Terraform", "ArgoCD"],
  },
  {
    name: "Auth & Observability",
    items: ["Auth0", "OpenFGA", "Honeycomb", "Grafana", "OpenSearch"],
  },
  {
    name: "Testing",
    items: ["JUnit", "MockK", "Mockito", "Kotest", "TestContainers", "PactFlow"],
  },
  {
    name: "CI/CD & Tools",
    items: ["GitHub Actions", "Jenkins", "Git", "GitHub", "GitLab", "Jira", "Confluence"],
  },
];
